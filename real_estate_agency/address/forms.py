...
street_autocomplete_widget = {
    'street': autocomplete.ModelSelect2(
        url='%s:street-autocomplete' % app_name)}

neighbourhood_autocomplete_widget = {
    'neighbourhood': autocomplete.ModelSelect2(
        url='%s:neighbourhood-autocomplete' % app_name)}
...
class CoordinateWidget(forms.widgets.TextInput):
    template_name = 'address/widgets/coordinates.html'
