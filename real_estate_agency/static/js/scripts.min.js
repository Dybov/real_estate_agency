...
$(function(){function e(e){function e(e,o,i){var l=parseFloat(n/100/12),a=parseFloat(12*i),t=(e-o)*(l*Math.pow(1+l,a)/(Math.pow(1+l,a)-1));return t.toFixed(0)}var o=$("#id_full_price").val(),i=o*$("#id_initial_fee_percentage").val()/100,l=$("#id_years").val();if(l<=7)n=7.4;else{var n=9.4;console.log("меньше 7 лет")}var a=parseInt(o),t=(a*n/100*l+a).toLocaleString(),s=e(o,i,l),c=Number(s).toLocaleString();console.log(c),console.log("slozkenit "+(a+a)),console.log(" тест "+(a*n/100*l+a)),$(".price_mouth").text(c),$(".actual_prestnt").text(n),$(".all_price").text(t),console.log("Ежемесячный платеж: "+e(o,i,l)+" руб"),console.log("Ежемесячный платеж: "+l+" лет")}$(".calc").mousemove(function(o){e()});var o=$(".plan_flex_container"),i=$("#min"),l=$("#max");o.isotope({itemSelector:".pop_up_plan"}),$("#filter").click(function(){var e=parseInt(i.val()),n=parseInt(l.val());o.find(".pop_up_plan").each(function(){var o=$(this),i=o.data("plan-price");i>e&&i<n&&o.addClass("show-me")}),o.isotope({filter:".show-me"}),$(".show-me").removeClass("show-me")})}),$(document).ready(function(){function e(){$("body").width()<769&&$(".airSticky").removeClass("airSticky")}$(".cal_flex_btn").remove(),$(".checkbox").click(function(e){$(this).parent(this).parent(this).toggleClass("active-checkbox")}),$(".search_form_select-select").styler(),window.onload=function(){$(".airSticky").airStickyBlock({debug:!0,stopBlock:".airSticky_stop-block",offsetTop:100})},e(),$(window).resize(e),$(".slider_price_year").slider({animate:"slow",range:"min",value:7,step:1,min:1,max:30,slide:function(e,o){$("#id_years").val(o.value)}}),$(".slider_price_one").slider({animate:"slow",range:"min",value:35,step:1,min:1,max:100,slide:function(e,o){costValue=o.value,costValue=costValue.toLocaleString(),$("#id_initial_fee_percentage").val(costValue)}}),$(".slider_price_home").slider({animate:"slow",range:"min",value:12e5,step:1e5,min:9e5,max:1e7,slide:function(e,o){$("#id_full_price").val(o.value)}}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(".menu_container").slideToggle(),!1}),$(".slider_item").magnificPopup({type:"image",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,mainClass:"my-mfp-zoom-in",gallery:{enabled:!0}}),$(".documents_item").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".callback").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".pop_up_plan").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".slider_soc_prog_item").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".popup_video").magnificPopup({type:"iframe",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,mainClass:"my-mfp-zoom-in"})}),function(){var e=document.querySelector("#flexy-nav__toggle"),o=document.querySelector("#flexy-nav__items");e.addEventListener("click",function(e){e.preventDefault(),o.classList.contains("flexy-nav__items--visible")?o.classList.remove("flexy-nav__items--visible"):o.classList.add("flexy-nav__items--visible")})}();