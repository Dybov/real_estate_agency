...
$(document).ready(function(){function e(){$("body").width()<769&&$(".airSticky").removeClass("airSticky")}$(".checkbox").click(function(e){$(this).parent(this).parent(this).toggleClass("active-checkbox")}),$(".search_form_select-select").styler(),window.onload=function(){$(".airSticky").airStickyBlock({debug:!0,stopBlock:".airSticky_stop-block",offsetTop:100})},e(),$(window).resize(e),$(".slider_price_year").slider({animate:"slow",range:"min",value:186e4,step:1e4,min:5e5,max:1e7,slide:function(e,i){$("#price_year").val(i.value)}}),$(".ipoteka_calc_input").change(function(){$price_home=$("#price_home").val(),$price_one=$("#price_one").val(),$price_year=$("#price_year").val(),$finale_price=parseInt($price_home)+parseInt($price_one)+parseInt($price_year),Number.isNaN($finale_price)?$(".finale_price").html("10"):$(".price_mouth").text($finale_price),console.log($finale_price)}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(".menu_container").slideToggle(),!1}),$(".slider_item").magnificPopup({type:"image",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,mainClass:"my-mfp-zoom-in",gallery:{enabled:!0}}),$(".documents_item").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".callback").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".pop_up_plan").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".slider_soc_prog_item").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in",focus:"#popup_input"}),$(".popup_video").magnificPopup({type:"iframe",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,mainClass:"my-mfp-zoom-in"})}),function(){var e=document.querySelector("#flexy-nav__toggle"),i=document.querySelector("#flexy-nav__items");e.addEventListener("click",function(e){e.preventDefault(),i.classList.contains("flexy-nav__items--visible")?i.classList.remove("flexy-nav__items--visible"):i.classList.add("flexy-nav__items--visible")})}();